...
msummary(list("(i)"=model1, "(ii)"=model2,"(iii)"=model3), coef_omit = "factor", gof_omit = ".*")
...
msummary(list("(iv)"=model_4, "(v)"=model_5,"(vi)"=model_6), coef_omit = "factor|Intercept", gof_omit = ".*")
...
msummary(list("(vii)"=model_7, "(viii)"=model_8, "(ix)"=model_9), coef_omit = "factor|Intercept", gof_omit = ".*")
